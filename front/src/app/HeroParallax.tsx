...
export default function HeroParallax() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0" ref={ref}>
      <Mountain className="animate-[mountain_10s_ease-in-out_infinite]" />
      ...
      <Roseau3 className="absolute bottom-0 left-1/4 hidden w-[15%] translate-x-[calc(var(--x)*45px)] translate-y-[calc(var(--y)*45px)] xl:block" />
